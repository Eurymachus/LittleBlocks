...
public class TileEntityChest extends TileEntity implements IInventory {
	...
	public boolean isUseableByPlayer(EntityPlayer par1EntityPlayer) {
		...
		if (worldObj instanceof LittleWorld) {
			return par1EntityPlayer.getDistanceSq(xCoord / 8D + 0.5D,
					yCoord / 8D + 0.5D, zCoord / 8D + 0.5D) <= 64D;
		}
	...
	public void checkForAdjacentChests() {
		if (!this.adjacentChestChecked) {
			...
			if (this.worldObj.getBlockId(this.xCoord - 1, this.yCoord,
					this.zCoord) == Block.chest.blockID) {
			...
			if (this.worldObj.getBlockId(this.xCoord, this.yCoord,
					this.zCoord - 1) == Block.chest.blockID) {
			...
			if (this.worldObj.getBlockId(this.xCoord, this.yCoord,
					this.zCoord + 1) == Block.chest.blockID) {
				this.adjacentChestZPosition = (TileEntityChest) this.worldObj
						.getBlockTileEntity(this.xCoord, this.yCoord,
								this.zCoord + 1);
			}
	...
	public void updateEntity() {
		...
		if (++this.ticksSinceSync % 20 * 4 == 0) {
			this.worldObj.sendClientEvent(this.xCoord, this.yCoord,
					this.zCoord, 1, this.numUsingPlayers);
		}
		...
		if (this.numUsingPlayers > 0 && this.lidAngle == 0.0F
			...
			this.worldObj.playSoundEffect(var2, this.yCoord + 0.5D, var4,
		...
		if (this.numUsingPlayers == 0 && this.lidAngle > 0.0F
			...
			if (this.lidAngle < var3 && var8 >= var3
				...
				this.worldObj.playSoundEffect(var4, this.yCoord + 0.5D, var6,
	...
	public void openChest() {
		...
		this.worldObj.sendClientEvent(this.xCoord, this.yCoord, this.zCoord, 1,
				this.numUsingPlayers);
	}
